            ...
            <div class="menu__inner">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_menu1.webp" alt="首・肩の施術風景" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_flow4.webp" alt="肩甲骨の施術風景" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_menu3.webp" alt="足の施術風景" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_menu4.webp" alt="足関節矯正の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_menu5.webp" alt="頸椎牽引矯正の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_menu6.webp" alt="猫背の矯正の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
        ...
        <section class="fee" id="fee">
            <div class="fee__inner">
                ...
                <?php if ( is_user_logged_in() && current_user_can('edit_posts') ) : ?>
                    <a class="btn btn--edit" href="<?php echo esc_url( home_url('/edit/') ); ?>">
                    料金表を編集
                    </a>
                <?php endif; ?>
            </div>
                ...
                <div class="flow__timeline">
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_flow1.webp" alt="受付のイメージ" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_flow2.webp" alt="温熱マット写真" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_flow3.webp" alt="検査・触診の様子" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_flow4.webp" alt="施術の様子" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_flow5.webp" alt="ご説明・アドバイスの様子" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
                                    関節の動きや痛みの程度を確認し、身体の状態を丁寧にチェックします。
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/seitai_flow6.webp" alt="ローラーベッドの写真" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
