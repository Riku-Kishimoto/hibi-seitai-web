            ...
            <div class="menu__inner">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_menu1.webp" alt="肩の治療の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_flow2.webp" alt="腰の治療の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_menu2.webp" alt="首まわりの治療の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_point2.webp" alt="交通事故治療の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="menu__grid">
                    <div class="menu__image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_menu3.webp" alt="自律神経調整施術の様子" loading="lazy" decoding="async"   width="300" height="200">
                    </div>
                    <div class="menu__items explanation">
                ...
                <div class="flow__timeline">
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_flow3.webp" alt="問診の様子" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_flow1.webp" alt="お身体の検査の様子" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_flow2.webp" alt="施術の様子" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
                    ...
                    <div class="flow__item">
                        <div class="flow__content">
                            ...
                            <div class="flow__image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/sekkotu_flow4.webp" alt="施術後の説明の様子" loading="lazy" decoding="async"   width="300" height="200">
                            </div>
                            <div class="flow__text">
                                <p>
